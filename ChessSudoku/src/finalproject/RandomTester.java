...
public class RandomTester {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < numPuzzles; i++) {
			...
			ChessSudokuTry puzzleCopy = deepCopyPuzzle(puzzle);
	...
	public static ChessSudokuTry seedPuzzle(int size, boolean knightRule,
			boolean kingRule, boolean queenRule) {
		ChessSudokuTry puzzle = new ChessSudokuTry(size);
	...
	private static ChessSudokuTry makeRandomPuzzle(int size, boolean knightRule,
		...
		ChessSudokuTry puzzle = seedPuzzle(size, knightRule, kingRule, queenRule);
	...
	private static ChessSudokuTry deepCopyPuzzle(ChessSudokuTry puzzle) {
		ChessSudokuTry newPuzzle = new ChessSudokuTry(puzzle.SIZE);
